...
class Redak:
    ...
    def __init__(self,root):
        ...
        self.main_entry_datum = main_entry_datum
        self.main_entry_otkup = main_entry_otkup
        self.main_entry_ustup = main_entry_ustup
        self.main_entry_datumipotpis = main_entry_datumipotpis
        ...
        Redak.instance_list.append(self)
