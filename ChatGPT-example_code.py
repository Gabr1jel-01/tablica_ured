...
def save_entries_main():
    ...
    for entry in main_all_entries_list_data:
        data1 = {
    ...
    # Check if the JSON file exists
        ...
        for entry_data in entry_data_list:
            ...
            if entry_key in entry_data:
                main_all_entries_list_data[main_entry_counter - 1].insert(0, entry_data[entry_key])
            main_entry_counter += 1
...
def main_add_row():
    ...
    what.append(main_entry_datumipotpis)
